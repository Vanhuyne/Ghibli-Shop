...
public class UserExcelExporter {
    ...
    public UserExcelExporter(List<Account> listUsers) {
    ...
    private void writeDataLines() {
        ...
        for (Account user : accounts) {
            ...
            createCell(row, columnCount++, user.getAdmin() ? "Admin" : "User", style);
            createCell(row, columnCount++, user.getActivated().toString(), style);
        }
    }
